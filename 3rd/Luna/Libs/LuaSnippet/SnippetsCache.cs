...
namespace Luna.Libs.LuaSnippet
{
        ...
        VgcApis.BaseClasses.Disposable
    {
        ...
        List<string> GenKeywords(IEnumerable<string> initValues) =>
            ...
            .Append(@" ")
            .Append(Models.Consts.Lua.NLuaKeyWords)
            .ToString()
        ...
        {
            var funcs = string.Join(" ", Models.Consts.Lua.NLuaPredefinedFunctions)
                + " "
        ...
        List<Dictionary<string, string>> GenWebUiSnippets(List<Tuple<string, Type>> apis)
        {
            ...
            */
            ...
            var predefinedFunctions = Models.Consts.Lua.LuaPredefinedSubFunctions
                .Concat(Models.Consts.Lua.NLuaPredefinedFunctions);
        ...
        void GenSnippetCaches()
        {
            var apis = new List<Tuple<string, Type>>
            {
                ...
                new Tuple<string,Type>("Sys", typeof(Interfaces.ILuaSys)),
                new Tuple<string,Type>("Misc", typeof(Interfaces.ILuaMisc)),

...
namespace Luna.Models.Consts
{
    public static class Lua
    {
        ...
        public static string NLuaApiFuncNames = string.Join(@" ", GetterApiFuncNames());
        ...
        public static List<string> NLuaPredefinedFunctions = new List<string>() { "Each" };

...
namespace NeoLuna.Interfaces
{
    public interface ILuaSys
    {
        ...
        #region file system
        bool WriteAllText(string file, string text);

        bool ClearFile(string file);
        bool WriteLine(string file, string text);
        string ReadAllText(string file);

        List<string> ReadAllLines(string file);

        int DeleteOldFiles(string dir, string dotExt, int keepNFiles);

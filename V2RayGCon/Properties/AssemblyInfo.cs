...
// v2rayn sharelink https://github.com/2dust/v2rayN/pull/9245

/*

v2.2.8.3 Add icons to I/O dialog in NeoLuna plug-in.
v2.2.8.2 Add copy-output feature in NeoLuna editor.
v2.2.8.1 Using round buttons.
--------------------------------------------------------------------
v2.2.7.7 Adjust width of index label in SubscriptionUI.
v2.2.7.6 Add browse-zip-file button in SubscriptionUI.
v2.2.7.5 Fix improper string cut-position in ZipDownloadTask.
v2.2.7.4 Fix main window freeze bug when doing batch actions.
v2.2.7.3 Import servers in parallel.
v2.2.7.2 Add std.Misc:ClearAstCache().
v2.2.7.1 Support redo() in editor.
--------------------------------------------------------------------
v2.2.6.9 Refactor Servers.configCache.
...
v2.2.6.4 Reduce userSettings.json size.
v2.2.6.3 Refactor InboundInfo.
v2.2.6.2 Use dictionary to compress config.
v2.2.6.1 Fix importing empty string casue crash bug.
--------------------------------------------------------------------
...
v2.2.5.7 Add std.Misc:ImportZipPackage() in NeoLuna plug-in.
v2.2.5.6 Replace inbounds info separator with semi-colon.
v2.2.5.5 Change inbound[0] to inbounds[0].
v2.2.5.4 Add property "ports" to InboundInfo.
v2.2.5.3 Auto scroll to bottom while redo or undo in FormToolbox.
v2.2.5.2 Fix index out of range bug in FormToolbox.
...
v2.2.4.5 Using more aggressive refresh strategy in ServerUI.
v2.2.4.4 Support server drag-drop of FormServerSelector in Composer plug-in.
v2.2.4.3 Replace pcn with vcn in sharelinks.
v2.2.4.2 Support pcn in vless://...
v2.2.4.1 Support pcs and sni of hy2://...
--------------------------------------------------------------------

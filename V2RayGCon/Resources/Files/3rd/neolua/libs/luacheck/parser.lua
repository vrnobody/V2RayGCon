local utils = require('3rd/neolua/libs/luacheck/utils')
local lexer = require('3rd/neolua/libs/luacheck/lexer')
local decoder = require('3rd/neolua/libs/luacheck/decoder')
...
function parser.parse(src, line_offsets, line_lengths)
   local decoded = decoder.decode(src)
   local state = new_state(decoded, line_offsets, line_lengths)
   skip_token(state)

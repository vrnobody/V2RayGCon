...
namespace V2RayGCon.Services.ShareLinkComponents.VeeCodecs.Obsolete
{
        ...
        IVeeDecoder
    {
        ...
        public bool IsDecoderFor(string version) => Models.VeeShareLinks.Obsolete.Ss1b.IsDecoderFor(version);

        public bool IsEncoderFor(string protocol) => Models.VeeShareLinks.Obsolete.Ss1b.IsEncoderFor(protocol);

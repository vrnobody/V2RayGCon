...
{
    internal sealed class Trojan5c : VgcApis.BaseClasses.ComponentOf<VeeDecoder>, IVeeDecoder
    {
        Cache cache;
        ...
        public string GetSupportedVeeVersion() => Models.VeeShareLinks.Obsolete.Trojan5c.version;
        ...
        {
            var veeLink = new Models.VeeShareLinks.Obsolete.Trojan5c(bytes);
        ...
        {
            var vee = new Models.VeeShareLinks.Obsolete.Trojan5c();
        ...
        {
            var vee = new Models.VeeShareLinks.Obsolete.Trojan5c(bytes);
            return new Models.Datas.VeeConfigsWithReality(vee.ToVeeConfigs());
        }
        #endregion

        #region private methods
        Models.VeeShareLinks.Obsolete.Trojan5c Config2Vee(JObject config)
        {
            ...
            var vee = new Models.VeeShareLinks.Obsolete.Trojan5c(bs);
        ...
        Tuple<JObject, JToken> VeeToConfig(Models.VeeShareLinks.Obsolete.Trojan5c vee)
        {
            if (vee == null)
            {
                return null;

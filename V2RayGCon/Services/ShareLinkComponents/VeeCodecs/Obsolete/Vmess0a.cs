...
namespace V2RayGCon.Services.ShareLinkComponents.VeeCodecs.Obsolete
{
        ...
        IVeeDecoder
    {
        ...
        public bool IsDecoderFor(string version) => Models.VeeShareLinks.Obsolete.Vmess0a.IsDecoderFor(version);

        public bool IsEncoderFor(string protocol) => Models.VeeShareLinks.Obsolete.Vmess0a.IsEncoderFor(protocol);

...
namespace V2RayGCon.Services.ShareLinkComponents.VeeCodecs
{
        ...
        IVeeDecoder
    {
        ...
        {
            var vee = new Models.VeeShareLinks.Ss1b();
        ...
        {
            var vee = new Models.VeeShareLinks.Ss1b(bytes);
            return vee.ToVeeConfigs();
        }
        #endregion

        #region public methods
        public bool IsDecoderFor(string version) => Models.VeeShareLinks.Ss1b.IsDecoderFor(version);

        public bool IsEncoderFor(string protocol) => Models.VeeShareLinks.Ss1b.IsEncoderFor(protocol);

...
namespace VgcApis.Libs.Streams
{
    public sealed class BitStream : BaseClasses.Disposable
    {
        ...
        public BitStream()
        {
            ...
            rawBitStream.Run();
            numberWriter = rawBitStream.GetChild<RawBitStream.Numbers>();
            bytesWriter = rawBitStream.GetChild<RawBitStream.Bytes>();
            uuidsWriter = rawBitStream.GetChild<RawBitStream.Uuids>();
            addressWriter = rawBitStream.GetChild<RawBitStream.Address>();
        }

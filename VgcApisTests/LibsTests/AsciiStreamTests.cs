...
namespace VgcApisTests.LibsTests
{
    ...
    public class AsciiStreamTests
    {
        ...
        public void ReadToBufferTest()
        {
            ...
            using (var stream = new VgcApis.Libs.Streams.AsciiStringStream(str))
            {
        ...
        public void ReadToStreamTest()
        {
            ...
            string s;
            using (var src = new VgcApis.Libs.Streams.AsciiStringStream(str))

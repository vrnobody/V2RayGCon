...
{
    [TestClass]
    public class UnicodeRoStrStreamTests
    {
        [TestMethod]
        public void ReadToBufferTest()
        {
            ...
            using (
                var stream = new VgcApis.Libs.Streams.ReadonlyStringStream(str, Encoding.Unicode)
            )
            {
        ...
        public void ReadToStreamTest()
        {
            ...
            string s;
            using (var src = new VgcApis.Libs.Streams.ReadonlyStringStream(str, Encoding.Unicode))

...
namespace VgcApisTests
{
    ...
    public class RawBitStreamTests
    {
        ...
        public RawBitStreamTests()
        {
            ...
            numbers = bitStream.GetChild<VgcApis.Libs.Streams.RawBitStream.Numbers>();
            bytesWriter = bitStream.GetChild<VgcApis.Libs.Streams.RawBitStream.Bytes>();
            uuids = bitStream.GetChild<VgcApis.Libs.Streams.RawBitStream.Uuids>();
            address = bitStream.GetChild<VgcApis.Libs.Streams.RawBitStream.Address>();
        }

...
mob://... 是 V2RayGCon v2.2.1.2 新增的分享链接类型。你可以在 [mob playground](../../pages/mob.html) 在线体验编、解码效果。这个链接支持 v2ray/xray 的多种协议，省去为每个协议定义一个分享链接的麻烦。
...
| ------- | ----------- | ----------- | ------- | ---------- | -------------------- | -------------------- | --------- | --- |
| tls     | server name | fingerprint | alpn    | ech        | pinnedPeerCertSha256 | verifyPeerCertByName |           |     |

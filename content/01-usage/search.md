...
| ------------ | ------------------------------- | ------------------------------------------------------- |
| name         | 服务器名字                      |                                                         |
| summary      | 服务器摘要                      | `vless.xhttp.reality@bing.com`                          |
| title        | 服务器标题                      | `123.[my-server] trojan.ws.tls@baidu.com`               |
| mark         | 标记                            |                                                         |
| remark       | 备注                            |                                                         |
| tag1-3       | 标签 1-3                        |                                                         |
| core         | 自定义 core 名                  |                                                         |
| selected     | 是否已选中                      | "True" 或 "False"                                       |
| running      | （v2.2.5+）是否正在运行         | "True" 或 "False"                                       |
| inbounds     | （v2.2.6+）分号分隔多个入站信息 | "http://127.0.0.1:1080,8080; socks://0.0.0.0:1080-1083" |
